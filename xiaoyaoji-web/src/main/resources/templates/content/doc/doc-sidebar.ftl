    ...
    <div class="sidebar bg">
        <div class="db-left-bar">
            ...
            <ul class="ta-c">
                ...
                <#if (docId?? && edit!false)>
                    <li class="db-item" uk-toggle="target: #save-modal"><a title="保存"><i class="iconfont icon-save"></i></a>
                    </li>
                </#if>
            </ul></#if>
            ...
            <div class="uk-modal-body" uk-overflow-auto>
                ...
                <table class="uk-table" v-show="!loading.history">
                    ...
                    <tr v-for="item in history">
                        <td><a :href="historyURL(item.docId,${(edit!false)?string('true','false')},item.id)">{{item.id}}</a>
                        </td>
        ...
        <div class="uk-modal-dialog">
                ...
                <div class="share-list-box " v-show="shareBox=='list'">
                    <ul class="share-list">
                        ...
                        <li v-for="item in shares" v-bind:class="{editing:item.editing}">
                            <div class="cb">
                                <a class="share-name fl" target="_blank" v-bind:href="'${ctx}/share/'+item.id">[{{item.username}}]
                                    {{item.name}} </a>
                                <#if editPermission>
                                <div class="fr">
                                ...
                                <input type="text" class="uk-input fr" v-bind:autofocus="item.editing"
                                       v-on:blur="shareLockBlur(item)" v-model="item.password"
                                       v-bind:value="item.password" placeholder="为空则表示不要密码">
                            </div>
                            <div class="cb">
                                <div class="fl share-doc-names">{{item.shareAll=='YES'?'整个项目':item.docNames}}
                                    {{item.docNames}}{{item.docNames}}{{item.docNames}}
                                </div>
                    ...
                    <form class="uk-form-horizontal uk-margin-large">
                        <div class="uk-margin">
                            ...
                            <div class="uk-form-controls">
                                <input class="uk-checkbox" id="form-all-project" v-model="share.shareAll"
                                       v-bind:true-value="'YES'" v-bind:false-value="'NO'" type="checkbox">
                            </div>
                        </div>
                        ...
                        <div class="uk-margin">
                            ...
                            <div class="uk-form-controls">
                                <input class="uk-input" maxlength="50" v-model="share.name" type="text"
                                       placeholder="请输入分享名称">
                            </div>
                        </div>
                        <div class="uk-margin">
                            ...
                            <div class="uk-form-controls">
                                <input class="uk-input" maxlength="20" v-model="share.password" type="text"
                                       placeholder="请输入阅读密码，为空表示不要密码">
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="uk-modal-footer uk-text-right">
                <div v-show="shareBox=='list'">
                    <button class="uk-button uk-button-default uk-modal-close" type="button">取消</button>
                    <#if editPermission>
                    <button class="uk-button uk-button-primary" type="button" v-on:click="shareBox='creation'">创建新分享
                    </button>
                    </#if>
                </div>
