                        ...
                        <ul class="uk-nav uk-dropdown-nav">
                            ...
                            <li><a :href="'${ctx}/project/'+item.id+'/export'"><span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                             viewBox="0 0 20 20" ratio="1"><path fill="none" stroke="#000"
                                                                                 stroke-width="1.1"
                                                                                 d="M6.5,14.61 L3.75,14.61 C1.96,14.61 0.5,13.17 0.5,11.39 C0.5,9.76 1.72,8.41 3.3,8.2 C3.38,5.31 5.75,3 8.68,3 C11.19,3 13.31,4.71 13.89,7.02 C14.39,6.8 14.93,6.68 15.5,6.68 C17.71,6.68 19.5,8.45 19.5,10.64 C19.5,12.83 17.71,14.6 15.5,14.6 L12.5,14.6"></path><polyline
                                                fill="none" stroke="#000"
                                                points="11.75 16 9.5 18.25 7.25 16"></polyline><path fill="none"
                                                                                                     stroke="#000"
                                                                                                     d="M9.5,18 L9.5,9.5"></path></svg>
                                    </span>导出</a></li>
                            <li v-on:click="rename(item.id,item.name)"><a>
                                <span><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                                           ratio="1"><path fill="none" stroke="#000"
                                                           d="M17.25,6.01 L7.12,16.1 L3.82,17.2 L5.02,13.9 L15.12,3.88 C15.71,3.29 16.66,3.29 17.25,3.88 C17.83,4.47 17.83,5.42 17.25,6.01 L17.25,6.01 Z"></path><path
                                        fill="none" stroke="#000" d="M15.98,7.268 L13.851,5.148"></path></svg></span>重命名</a>
                            </li>
                            ...
                            <li v-on:click="archiveProject(item.id)"><a><span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                             viewBox="0 0 20 20" ratio="1"><path fill="none" stroke="#000"
                                                                                 d="M17.25,6.01 L7.12,16.1 L3.82,17.2 L5.02,13.9 L15.12,3.88 C15.71,3.29 16.66,3.29 17.25,3.88 C17.83,4.47 17.83,5.42 17.25,6.01 L17.25,6.01 Z"></path><path
                                                fill="none" stroke="#000" d="M15.98,7.268 L13.851,5.148"></path></svg>
                                    </span>归档</a>
                            </li>
                            <li v-on:click="deleteProject(item.id)"><a><span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                             viewBox="0 0 20 20" ratio="1"><polyline fill="none" stroke="#000"
                                                                                     points="6.5 3 6.5 1.5 13.5 1.5 13.5 3"></polyline><polyline
                                                fill="none" stroke="#000"
                                                points="4.5 4 4.5 18.5 15.5 18.5 15.5 4"></polyline><rect x="8" y="7"
                                                                                                          width="1"
                                                                                                          height="9"></rect><rect
                                                x="11" y="7" width="1" height="9"></rect><rect x="2" y="3" width="16"
                                                                                               height="1"></rect></svg>
                                    </span>删除</a>
                            </li>
                    ...
                    <div class="new-project-btns">
                        <div class="np-btns-item" uk-toggle="target: #importModal">
                            ...
                            <div class="nb-btn" style="background-color: #00bcd5">
                                <span class="uk-icon"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                        ...
                                        fill="none" stroke="#000" points="7.25 11.75 9.5 9.5 11.75 11.75"></polyline><path
                                        fill="none" stroke="#000" d="M9.5,18 L9.5,9.5"></path></svg></span>
                            </div>
                        </div>
                        <div class="np-btns-item" uk-toggle="target: #createModal">
                            ...
                            <div class="nb-btn" style="background-color: #f24029">
                                <span class="uk-icon"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                           viewBox="0 0 20 20" ratio="1"><rect x="9" y="1" width="1"
                                                                                               height="17"></rect><rect
                                        x="1" y="9" width="17" height="1"></rect></svg></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form class="uk-form-stacked">
                    <div class="uk-margin">
                        ...
                        <div class="uk-form-controls">
                            <input class="uk-input" v-model="name" autofocus id="form-stacked-text" type="text"
                                   placeholder="请输入项目名称"
                                   maxlength="50">
                        </div>
                    </div>
                    ...
                    <div class="uk-margin uk-grid-small uk-child-width-auto" uk-grid>
                        <label><input class="uk-radio" type="radio" v-model="permission" value="PUBLIC"
                                      name="permission"
                                      checked> 公开项目</label>
                        <label><input class="uk-radio" type="radio" v-model="permission" value="PRIVATE"
                                      name="permission">
                            私有项目</label>
                    </div>
                </form>
    ...
    <div id="importModal" v-cloak uk-modal>
        <div class="uk-modal-dialog">
            ...
            <div class="uk-modal-body">
                ...
                <#if importPlugins??>
                    <#list importPlugins as item>
                        <li class="ta-c">
                            <div>
                                <img class="plugin-icon"
                                     src="${ctx}/proxy/${item.id}/${item.icon.icon32x32}?v=${item.version}"/><br/>
                                <span>${item.name}</span>
                            </div>
