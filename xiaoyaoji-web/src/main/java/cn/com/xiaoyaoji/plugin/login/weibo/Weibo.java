...
public class Weibo {
     ...
     * @return
     */
    public WeiBoUser showUser(String accessToken, String uid){
        ...
        return JSON.parseObject(rs,WeiBoUser.class);
    }
     ...
     * @return
     */
    public WeiBoAccessToken getAccessToken(String appKey, String appSecret, String code, String redirectUri){
        ...
        WeiBoAccessToken accessToken = JSON.parseObject(rs, WeiBoAccessToken.class);
